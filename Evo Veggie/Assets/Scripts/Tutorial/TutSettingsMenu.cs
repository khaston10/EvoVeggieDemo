...
public class TutSettingsMenu : MonoBehaviour
{
    ...
    private void Update()
    {
        if (Input.GetKeyDown(KeyCode.Escape) && settingsActive == false)
        {
            ...
            settingsActive = true;
            GameObject.Find("Game").GetComponent<TutGameMain>().gamePaused = true;
        }
        ...
        else if (Input.GetKeyDown(KeyCode.Escape) && settingsActive == true)
        {
            ...
            GameObject.Find("Game").GetComponent<TutGameMain>().gamePaused = false;
        }
    }
